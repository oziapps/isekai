...
2. **Güncel sürümler [A]:** Godot 4.5 (2025-09-15), 4.6 (2026-01-25), 4.7 (2026-06-17), **4.7.2 (2026-08-16)**. (Not, 24.09.2026: bunlar etiket commit tarihleri. Resmî CHANGELOG/duyuru tarihleri 4.6 için 2026-01-26, 4.7 için 2026-06-18, 4.7.2 için 2026-08-17.) `master` dalı 4.8-dev. Unity 6.3 (6000.3, 2025-12-03, **LTS**), 6.4 (2026-03-18), 6.5 (2026-06-15), **6.6 (6000.6.2f1, 2026-09-18)**; 6.7 beta. Unreal: 5.7 (2025-11-12), **5.8.0 (2026-06-17), 5.8.3 (2026-09-22)**. 5.8 son UE5 sürümü olarak planlanıyor [B].
...
8. **Konsol:** Godot MIT olduğu için resmî konsol desteği yok. Yol üçüncü taraflardan geçiyor: W4 Games (Switch, Switch 2, Xbox Series, PS5), Lone Wolf, Pineapple Works, RAWRLAB, Sickhead vd. [A]. W4 Consoles ücreti 800 $/yıl/platform ya da 2.000 $/yıl tüm platformlar (<300 bin $ gelir ve <30 çalışan), gelir payı yok [B]. **Düzeltme (24.09.2026):** Starter katmanı tek konsol için 800 $/yıl, **üç konsol için** 2.000 $/yıl; yıllık gelir sınırı 300 bin $ ve gelir payı yok (doğrulandı). "<30 çalışan" şartı ve Pro katmanı fiyatları doğrulanamadı. W4 bir ara katman (middleware); konsol üreticisine geliştirici kaydı, onay, devkit (fiyatı gizli) ve bölgesel derecelendirme ayrıca gerekiyor, yani toplam konsol maliyeti W4 aboneliğinden yüksek.
9. **Lisans ve maliyet:** Godot MIT, telif yok. Unity Personal, son 12 ayda **200.000 $ "Total Finances"** eşiğine kadar ücretsiz (fon da sayılıyor). Unity 6 ve öncesi için "royalty, revenue share veya runtime fee yok" maddesi şart metninde [A]. Pro 2.310 $/yıl/koltuk [B] (doğrulandı 24.09.2026: 12 Ocak 2026'dan beri, önceki fiyat 2.200 $). Unreal'da ürün başına ömür boyu ilk 1 M $'dan sonra %5 telif, "Launch Everywhere with Epic" ile %3,5, EGS gelirine telif yok [B] (doğrulandı 24.09.2026: %3,5 oran yalnızca oyun PC'de Epic Games Store'da diğer mağazalarla aynı gün ya da önce çıkarsa geçerli; EGS geliri 1 M $ eşiğine de sayılmıyor).
...
11. **GDScript mi C# mı?** 7k★'lı godogen projesi GDScript'ten C#'a geçti (2026-04-06), gerekçesi LLM'in C#'ta ilk denemede daha doğru kod üretmesi [B] (24.09.2026'da deponun CHANGELOG ve `docs/gdscript-vs-csharp.md` dosyasından birincil olarak doğrulandı → [A]). Ama Godot 4'te C# **web'e export edilemiyor**, Android/iOS'ta **deneysel** [A]. Ben GDScript'te `untyped_declaration=Error` + `--check-only` kapısının aynı hata sınıfını parse aşamasında yakaladığını doğruladım [A]. Öneri: katı GDScript. Sıcak yollar gerekirse GDExtension.
...
|---|---|---|---|---|
| Godot | **4.7.2-stable** | 2026-08-16 | 4.7: 2026-06-17 · 4.6: 2026-01-25 · 4.5: 2025-09-15 · `master` = 4.8-dev. (Etiket commit tarihleri; resmî CHANGELOG tarihleri 4.6: 01-26, 4.7: 06-18, 4.7.2: 08-17; düzeltildi 24.09.2026) | [A][1][2] |
| Unity | **6.6 (6000.6.2f1)** | 2026-09-18 | 6.3 = **LTS** (6000.3.0f1: 2025-12-03; resmî duyuru 2025-12-04, Aralık 2027'ye kadar destek; 6000.3.24f1'e kadar yama), 6.4: 2026-03-18, 6.5: 2026-06-15, 6.7 beta 1: 2026-09-17. **6.7'nin 2026 sonunda sıradaki LTS olması bekleniyor** (eklendi 24.09.2026) | [A][9][10] |
...
| Konsol ek maliyeti | W4: 800 $/platform/yıl ya da 2.000 $/yıl tümü (<300 bin $ gelir, <30 kişi). Pro: 4.000 $ / 10.000 $. Gelir payı yok [B][19]. (Düzeltildi 24.09.2026: 2.000 $ üç konsol için Starter fiyatı ve 300 bin $ gelir sınırı doğrulandı; "<30 kişi" ve Pro fiyatları doğrulanamadı. Devkit, geliştirici kaydı ve derecelendirme ayrıca ödenir.) | Pro lisansı [B] | Yok [C] |
...
8. **Konsol: PC (Steam) + Steam Deck önce.** Konsol için 1.0 + 12–24 ay içinde W4 ya da bir porting ortağı değerlendirilir (lisans maliyeti ~2.000 $/yıl [B]; üç konsol için Starter fiyatı olarak doğrulandı. Buna konsol üreticisine kayıt, devkit ve derecelendirme maliyetleri eklenmeli; düzeltildi 24.09.2026). Bu yüzden şimdiden: gamepad-öncelikli UI, yalnızca GDScript, platforma özel kod `platform/` soyutlamasının arkasında.
...
> Bağımsız doğrulama turu (adversarial fact-check). Godot ve Unity iddiaları raw.githubusercontent.com üzerinden birincil dosyalardan (CHANGELOG, godot-website sürüm verisi, godot-docs, Unity şart metni, godogen deposu) yeniden okundu. W4, Unreal ve Unity fiyatları farklı sorgularla web aramasından kontrol edildi.

| İddia | Sonuç | Düzeltme/Not | Kaynak |
|---|---|---|---|
| Godot 4.5 2025-09-15, 4.6 2026-01-25, 4.7 2026-06-17, 4.7.2 2026-08-16 | Düzeltildi (küçük) | Raporda etiket commit tarihleri var. Resmî CHANGELOG/duyuru: 4.5 2025-09-15, 4.6 **2026-01-26**, 4.7 **2026-06-18**, 4.7.2 **2026-08-17**. Karar etkisi yok | https://raw.githubusercontent.com/godotengine/godot/4.6-stable/CHANGELOG.md · https://raw.githubusercontent.com/godotengine/godot/master/CHANGELOG.md · https://raw.githubusercontent.com/godotengine/godot/4.7.2-stable/CHANGELOG.md |
| 4.5'te stencil buffer; StandardMaterial3D'de hazır Outline ve X-Ray modları | Doğrulandı | Nüans: stencil'e yazan materyaller her zaman **şeffaf geçişte** çizilir (şeffaflık sıralama sınırlamaları geçerli). Outline için mesh'in bağlı yüzleri/paylaşılan köşeleri olmalı (smooth shading). Rendering Spike'ta test edilmeli | https://raw.githubusercontent.com/godotengine/godot-docs/master/tutorials/3d/standard_material_3d.rst · https://raw.githubusercontent.com/godotengine/godot/4.5-stable/CHANGELOG.md |
| 4.6: Jolt yeni 3D projelerde varsayılan; yeni IK çatısı (IKModifier3D, TwoBoneIK3D, SplineIK3D, FABRIK3D, CCDIK3D, JacobianIK3D) | Doğrulandı | Mevcut projelerin fizik ayarı değişmiyor, yalnızca yeni projeler Jolt ile başlıyor | https://raw.githubusercontent.com/godotengine/godot-website/master/_data/release_4_6/features.yml |
| 4.7: HDR çıktı, AreaLight3D, Asset Store, `Tween.tween_await` | Doğrulandı | HDR çıktı Windows, macOS, iOS, visionOS ve Linux (Wayland) için | https://raw.githubusercontent.com/godotengine/godot-website/master/_data/release_4_7/features.yml |
| Godot 4'te C# web'e export edilemiyor; Android/iOS deneysel; 4.5+ .NET 8, Android .NET 9 | Doğrulandı | godot-docs `c_sharp_basics.rst` | https://raw.githubusercontent.com/godotengine/godot-docs/master/tutorials/scripting/c_sharp/c_sharp_basics.rst |
| godogen 2026-04-06'da GDScript'ten C#/.NET 9'a geçti; LLM'lerin C# enum adlarında güvenilmez olduğu notu | Doğrulandı | Depo CHANGELOG'u ve `docs/gdscript-vs-csharp.md`; [B] → [A] | https://raw.githubusercontent.com/htdt/godogen/HEAD/CHANGELOG.md · https://raw.githubusercontent.com/htdt/godogen/HEAD/docs/gdscript-vs-csharp.md |
| Unity Personal eşiği 200.000 $ Total Finances; aşılırsa prototip için bile kullanılamaz; Unity 6 ve öncesi için runtime fee yok | Doğrulandı | Şart metni "Last Updated: June 30, 2026". Runtime fee muafiyeti yalnızca "Unity 6 veya önceki sürümler" için yazılı | https://raw.githubusercontent.com/Unity-Technologies/TermsOfService/HEAD/Unity%20Software%20Additional%20Terms.md |
| Unity 6.3 LTS 2025-12-03 | Doğrulandı (küçük nüans) | Resmî duyuru 2025-12-04; LTS desteği Aralık 2027'ye kadar. 6.4/6.5/6.6 "Supported Update"; 6.7'nin 2026 sonunda LTS olması bekleniyor | https://unity.com/blog/unity-6-3-lts-is-now-available · https://makaka.org/unity-tutorials/best-version |
| Unity Pro 2.310 $/yıl/koltuk [B] | Doğrulandı | 12 Ocak 2026'dan beri (önceki 2.200 $, %5 artış) | https://80.lv/articles/unity-announces-its-upcoming-2026-price-changes · https://unity.com/products/pricing-updates |
| Unreal: ilk 1 M $'dan sonra %5; Launch Everywhere ile %3,5; EGS geliri muaf [B] | Doğrulandı (koşul eklendi) | %3,5 yalnızca oyun PC'de EGS'de diğer mağazalarla aynı gün ya da önce çıkarsa (1 Ocak 2025'ten beri); aksi hâlde %5'e döner. EGS geliri 1 M $ eşiğine de sayılmıyor | https://www.pocketgamer.biz/unreal-engine-royalty-fee-reducing-to-35-for-games-landing-on-epic-games-store-on-launch-day/ · https://www.cgchannel.com/2024/10/epic-games-to-cut-royalty-rate-on-unreal-engine-games/ |
| W4 Consoles: 800 $/yıl/platform ya da 2.000 $/yıl tümü (<300 bin $ gelir, <30 çalışan); Pro 4.000 $ / 10.000 $ [B] | Düzeltildi (kısmen doğrulandı) | Starter: tek konsol 800 $/yıl, **üç konsol** 2.000 $/yıl, yıllık gelir sınırı 300 bin $, gelir payı yok (doğrulandı). "<30 çalışan" ve Pro fiyatları doğrulanamadı. Konsol üreticisine kayıt, onay, devkit ve derecelendirme ayrıca gerekiyor | https://www.w4games.com/blog/w4-games-news-1/w4-games-announces-pricing-model-for-console-ports-5 · https://gamefromscratch.com/w4-games-release-godot-w4-console-pricing/ · https://raw.githubusercontent.com/godotengine/godot-website/master/pages/consoles.html |

**Karar etkisi:** Godot 4.7.2 + katı GDScript önerisi değişmiyor; motor özellik iddiaları birincil kaynakla doğrulandı. İki pratik ekleme var: (1) stencil outline şeffaf geçişte çizildiği için Rendering Spike'ta sıralama ve saç/yüz kesişimleri özellikle test edilmeli; (2) konsol bütçesi W4 aboneliğiyle sınırlı değil, devkit ve kayıt maliyetleri de eklenmeli. Unity'ye geri dönüş planı 2027'ye kayarsa hedef 6.7 LTS olmalı.
